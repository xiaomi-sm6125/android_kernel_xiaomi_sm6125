...
//+bug xxx add by machengcheng@wt for usb check for tp
...
irqreturn_t default_irq_handler(int irq, void *data)
{
	...
	if(!strcmp(irq_data->name,"input-current-limiting"))//bug 455387 zhaolinquan.wt, MODIFY, 20190704, reduce charge log
...
//+Extb 59334,xujianbang.wt,Modify,20190614,Limit HVDCP when XIAOMI Charger error.
#ifdef GET_RTC_TIME
...
//+bug 448305 zhaolinquan.wt, MODIFY, 20190528, setting SDP 500mA if USB driver has issues
...
void smblib_usb_plugin_locked(struct smb_charger *chg)
{
	...
	if (vbus_rising) {
		...
		//+bug xxx add by machengcheng@wt for usb check for tp 2019-11-8
...
static void usb_current_worker(struct work_struct *work)
{
	...
	//+Extb 64830, zhaolinquan.wt, MODIFY, 20190604, for compate audio adapter
	int suspend = 0;
...
//+bug 444969 zhaolinquan.wt, MODIFY, 20190508, battery temp above 45 degree setting voltage 4.1V
#if 0
